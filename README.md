...
Api contains three endpoints:
  ...
  >>  Method      <=> GET,
      ...
      Usage       <=> Compare two strings and return result:
                      ...
                      On success : Status Code = 200 OK , Response body = { "resultType": "Equals", "diffs": [] },
                                || Status Code = 200 OK , Response body = { "resultType": "SizeDoNotEqual", "diffs": [] },
                                || Status Code = 200 OK , Response body = { "resultType": "ContentDoNotEqual", "diffs": [{ "offset": 0, "length": 2 }] },
